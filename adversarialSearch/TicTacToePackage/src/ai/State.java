...
/**
 * Adapted from the assignment originally from 
 * <a href="http://classes.engr.oregonstate.edu/eecs/spring2012/cs331/assignments/programming2/programming2.html">Chris Ventura</a> (university of Oregon)
 * @author meneguzzi
 *
 */
public class State {
	...
	public void setState(int row, int col, String playerSymbol) throws Exception {
		...
		if( !playerSymbol.equals(State.X) && !playerSymbol.equals(State.O)) {
	...
	private boolean isVerticalWin(int player) throws Exception {
		...
		String playerSymbol;
		if ((player < 0) || (player > State.PLAYER_O)) {
